...
comp50 <- as.data.frame(cbind(x1,x2,x3,y))
...
mcar50 <- as.data.frame(cbind(x1.mcar,x2.mcar,x3.mcar,y))
...
mar50 <- as.data.frame(cbind(x1.mar,x2.mar,x3.mar,y))

save(comp50,file="data/R/comp50.Rdata")
save(mcar50,file="data/R/mcar50.Rdata")
save(mar50, file="data/R/mar50.Rdata")

write.csv(comp50,file="data/csv/comp50.csv")
write.csv(mcar50,file="data/csv/mcar50.csv")
write.csv(mar50,file="data/csv/mar50.csv")
